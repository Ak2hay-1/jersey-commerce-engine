  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-3 sm:flex-row">
        <Button type="button" className="store-cta flex-1" disabled={!canBuy || pending} onClick={() => void add(false)}>
          {addLabel}
        </Button>
        <Button type="button" variant="outline" className="store-cta flex-1" disabled={!canBuy || pending} onClick={() => void add(true)}>
          Buy now
        </Button>
      </div>
    </div>
