      ...
      <Card className="w-full max-w-md">
        <CardHeader>
          ...
          <CardDescription>
            {auth.user?.mustChangePassword
              ? 'This is a temporary password. Set a new one before you can use the staff console.'
        ...
        <CardContent>
          <form className="space-y-4" onSubmit={(event) => void onSubmit(event)}>
            ...
            <Button type="submit" className="w-full" disabled={submitting || auth.loading || !auth.user}>
